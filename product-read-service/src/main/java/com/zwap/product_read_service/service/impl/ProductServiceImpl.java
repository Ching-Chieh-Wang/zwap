...
import com.zwap.product_common.exception.ProductPendingException;
import com.zwap.product_common.mapper.ProductMapper;
import com.zwap.product_common.variable.RedisPrefix;
import com.zwap.product_common.variable.RedisTTL;
...
public class ProductServiceImpl implements IProductService {
    ...
    public ProductVO getVOById(String id) {
        ...
        if (cachedProduct == null) {
            ...
            final String token = Thread.currentThread().getName() + "-" + UUID.randomUUID().toString();
    ...
    @Override
    public boolean checkOwnership(String id, String userId) {
